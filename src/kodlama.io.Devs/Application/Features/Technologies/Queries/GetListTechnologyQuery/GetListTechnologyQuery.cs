...
namespace Application.Features.Technologies.Queries.GetListTechnologyQuery
{
    public  partial class GetListTechnologyQuery:IRequest<TechnologyListModel>
    {
        ...
        public class GetListTechnologyQueryHandler : IRequestHandler<GetListTechnologyQuery, TechnologyListModel>
        {
            ...
            public async Task<TechnologyListModel> Handle(GetListTechnologyQuery request, CancellationToken cancellationToken)
            {
                ...
                TechnologyListModel mappadTechnologyListModel = _mapper.Map<TechnologyListModel>(technologies);
                return mappadTechnologyListModel;
            }
        }
